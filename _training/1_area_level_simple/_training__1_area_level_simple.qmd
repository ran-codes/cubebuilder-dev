...
{ ## Renovation notebook specific setup
  ...
  local_config = lst(
    ...
    dataset_id_tmp = "_training__1_area_level_simple", # Dataset ID name. Example: 'LE_L1'
    ...
    raw_dataset_dir = file.path(record_path,'_raw'), # Unencrypted server data location. Example: 'Data/Mortality Data/Life Expectancy/'
...
df_var_name = tibble(var_name_raw = local_context$raw_data %>% 
  ...
  select(
    all_of(local_context$vec__admin_variable_definition_table_columns)
  ) %>%
  distinct() 
